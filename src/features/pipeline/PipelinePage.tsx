...
function InstructionDetail({
    ...
    return (
        <div className="flex flex-col gap-4">
            <CollapsibleSection
                id="pipeline-instruction-details"
            ...
            {selInstr && selInstr.stallBefore > 0 ? (
                <CollapsibleSection
                    id="pipeline-why-stalls"
                    tone="rose"
                    title={`Why it stalls (${selInstr.stallBefore} bubble${
                        selInstr.stallBefore > 1 ? 's' : ''
                    })`}
                >
                    <div className="p-3">
                        <p className="text-[11px] leading-snug text-rose-700 dark:text-rose-200">
...
export default function PipelinePage({
    ...
    return (
        <div className="mx-auto flex w-full max-w-[1760px] flex-col gap-4 p-3 sm:p-4 lg:p-6">
            ...
            <CollapsibleSection
                id="pipeline-initial-values"
                title="Initial Register / Memory Values"
                subtitle="Set starting values for registers and memory before the program runs (needed when branches depend on inputs)."
                defaultOpen={false}
            >
                <div className="p-3">
                    <div className="space-y-4">
                        ...
                        <div className="grid items-start gap-4 md:grid-cols-2">
                            <RegisterTable
                                sectionId="pipeline-initial-registers"
                            ...
                            />
                            <MemoryTable
                                sectionId="pipeline-initial-memory"
                                machine={initialMachine}
            ...
            <div className="grid gap-4 lg:grid-cols-[320px_minmax(0,1fr)] xl:grid-cols-[300px_minmax(0,1fr)_320px]">
                ...
                <div className="flex flex-col gap-4">
                        ...
                        <div className="p-3">
                            ...
                            {trace.truncated ? (
                                <p className="mt-2 text-[11px] text-amber-600">
                                    Showing the first {instructionCount}{' '}
                                    executed instructions (step limit reached —
                                    long or infinite loop).
                                </p>
                            ) : null}
                    ...
                    <CollapsibleSection id="pipeline-options" title="Options">
                        <div className="p-3">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    {selStep ? (
                        <>
                            <CollapsibleSection
                                id="pipeline-registers-after"
                                title={`Registers (after #${selRow + 1})`}
                            >
                                <div className="p-3">
                                    <RegisterList
                            ...
                            <CollapsibleSection
                                id="pipeline-memory-after"
                                title={`Data Memory (after #${selRow + 1})`}
                                defaultOpen={false}
                            >
                                <div className="p-3">
                                    <MemoryList
