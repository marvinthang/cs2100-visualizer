        ...
        <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            <div className="grid gap-5 px-5 py-4 lg:grid-cols-[minmax(240px,0.65fr)_minmax(0,1.35fr)] lg:items-center">
                <div>
                    ...
                    <div className="mt-1 font-mono text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2 xl:grid-cols-3">
                        {arrayStats.map((array, index) => (
                            ...
                            >
                                ...
                                <div className="mt-2 grid grid-cols-2 gap-px overflow-hidden rounded bg-slate-200 ring-1 ring-slate-200">
