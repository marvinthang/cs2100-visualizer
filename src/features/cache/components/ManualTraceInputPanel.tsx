...
export default function ManualTraceInputPanel({
    ...
    return (
        <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex flex-col gap-4 border-b border-slate-200 bg-[#fbfcfd] px-4 py-3 sm:flex-row sm:items-end sm:justify-between dark:border-slate-800 dark:bg-slate-900/60">
                <div>
                ...
                <div className="w-full sm:w-[180px]">
                    ...
                    <div className="grid grid-cols-2 rounded-md bg-slate-100 p-1 ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-800">
                        <SegmentButton
                            value="hexadecimal"
            ...
            <div className="p-4">
                <textarea
                    ...
                    spellCheck={false}
                    className="min-h-40 w-full resize-y rounded-md border border-slate-300 bg-slate-50 px-3 py-3 font-mono text-sm leading-7 text-slate-900 shadow-inner outline-none transition placeholder:text-slate-400 focus:border-slate-500 focus:bg-white focus:ring-2 focus:ring-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-400 dark:focus:bg-slate-800"
                />
