...
export default function AccessInspector({
    ...
    return (
        <aside className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm 2xl:sticky 2xl:top-4">
            ...
            <div className="p-4">
                <p className="mb-2 font-mono text-[9px] font-bold uppercase tracking-[0.14em] text-slate-500">
                    32-bit address split
                </p>
                <div className="flex min-h-24 overflow-x-auto overflow-y-hidden rounded-md border border-slate-200">
                    <BitField
                        label="Tag"
                        bits={layout.tagBits}
                ...
                <div className="mt-4 grid grid-cols-3 gap-px overflow-hidden rounded-md bg-slate-200 text-center ring-1 ring-slate-200">
                    {[
