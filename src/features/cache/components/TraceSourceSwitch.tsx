    ...
    return (
        <section className="rounded-lg border border-slate-200 bg-white p-2.5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <fieldset className="grid min-w-0 flex-1 grid-cols-3 gap-1 rounded-md bg-slate-100 p-1 ring-1 ring-inset ring-slate-200 dark:bg-slate-800 dark:ring-slate-700 sm:max-w-4xl">
