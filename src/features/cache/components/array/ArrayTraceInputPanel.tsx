                ...
                {loopFields.map((field) => (
                    <label key={field.key}>
                        ...
                        <input
                            ...
                            className="mt-1 w-full rounded border border-slate-300 bg-white px-2 py-2 font-mono text-sm font-semibold text-slate-900 outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-100"
                        />
                    </label>
                ))}
            </div>
