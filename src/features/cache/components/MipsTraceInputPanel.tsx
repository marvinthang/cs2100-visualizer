            ...
            <div className="p-4">
                ...
                <div className="mt-3 rounded-md border border-slate-200 bg-slate-50 p-3">
                    ...
                    {accessMode === 'instruction' && (
                        <div className="mt-3 grid gap-3 border-t border-slate-200 pt-3 sm:grid-cols-[minmax(0,1fr)_180px] sm:items-end">
                            <label>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 font-mono text-xs font-semibold text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-slate-500 focus:ring-2 focus:ring-slate-100"
                                />
                            </label>
