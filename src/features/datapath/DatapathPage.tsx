                ...
                <div className="grid min-h-0 flex-1 gap-4 xl:grid-cols-[310px_minmax(720px,1fr)_370px] 2xl:grid-cols-[320px_minmax(880px,1fr)_380px]">
                    <aside className="min-h-0 space-y-3 xl:overflow-y-auto xl:pr-1">
                        <CollapsibleSection
                            ...
                            title="Setup"
                            meta={
                                <span className="shrink-0 rounded-md border border-slate-200 bg-white px-2 py-1 text-xs font-semibold capitalize text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
                                    {mode}
                                </span>
                            }
                        >
