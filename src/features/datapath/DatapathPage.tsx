...
function StatusPill({
    ...
    return (
        <div className="rounded-md border border-slate-200 bg-white px-3 py-2 shadow-sm dark:border-slate-800 dark:bg-slate-900">
...
function SignalLegend({
    ...
    return (
        <span className="inline-flex items-center gap-1.5 rounded-md border border-slate-200 bg-white px-2 py-1 text-xs font-semibold text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
...
export default function DatapathPage() {
    ...
    return (
        <main className="flex h-full min-h-0 flex-col bg-[#eef2f3] p-3 text-slate-900 dark:bg-slate-950 dark:text-slate-100 sm:p-4 lg:p-5 xl:overflow-hidden">
            <div className="mx-auto flex h-full min-h-0 w-full max-w-[1760px] flex-col gap-4">
                <header className="flex-none overflow-hidden rounded-lg border border-slate-200 bg-[#fbfcfd] shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div className="flex flex-col justify-between gap-3 border-b border-slate-200 px-4 py-3 dark:border-slate-800 lg:flex-row lg:items-center">
                        <div>
                ...
                <div className="grid min-h-0 flex-1 gap-4 xl:grid-cols-[310px_minmax(720px,1fr)_370px] 2xl:grid-cols-[320px_minmax(880px,1fr)_380px]">
                    <aside className="min-h-0 space-y-3 xl:overflow-y-auto xl:pr-1">
                        <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <div className="flex items-center justify-between gap-3 border-b border-slate-200 bg-[#fbfcfd] px-4 py-3 dark:border-slate-800 dark:bg-slate-900/60">
                                ...
                                <span className="rounded-md border border-slate-200 bg-white px-2 py-1 text-xs font-semibold capitalize text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
                                    {mode}
                                </span>
                            </div>

                            <div className="p-3">
                                <div className="grid grid-cols-3 rounded-md bg-slate-100 p-1 ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                                ...
                                {mode !== 'assembly' && (
                                    <label className="mt-3 block">
                                        ...
                                        <select
                                            ...
                                            className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-slate-500 dark:focus:ring-slate-700"
                                        >
                        ...
                        <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <div className="flex items-center justify-between gap-2 border-b border-slate-200 bg-[#fbfcfd] px-4 py-3 dark:border-slate-800 dark:bg-slate-900/60">
                                <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">
                                    Control Signals
                                </h2>
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className="rounded-md border border-slate-300 bg-white px-2 py-1 text-xs font-semibold text-slate-700 shadow-sm transition hover:border-slate-400 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:border-slate-600 dark:hover:bg-slate-700"
                                    >
                                        Reset
                                    </button>
                                    <button
                                        ...
                                        className={`rounded-md px-2 py-1 text-xs font-semibold ${
                                            isEditingSignals
                                                ...
                                                : 'border border-slate-300 bg-white text-slate-700 shadow-sm transition hover:border-slate-400 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:border-slate-600 dark:hover:bg-slate-700'
                                        }`}
                                    >
                    ...
                    <section className="flex min-h-0 min-w-0 flex-col overflow-hidden rounded-lg border border-slate-300 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                        <div className="flex flex-none flex-wrap items-center justify-between gap-3 border-b border-slate-200 bg-[#fbfcfd] px-4 py-3 dark:border-slate-800 dark:bg-slate-900/60">
                            <div>
                        ...
                        <div className="flex min-h-0 flex-1 items-center justify-center overflow-hidden bg-[#f8fafc] p-3 dark:bg-slate-950">
                            <div className="flex h-full w-full items-center justify-center overflow-hidden rounded-md border border-slate-200 bg-white shadow-inner dark:border-slate-700 dark:bg-[#1e293b]">
                                <DatapathDiagram
                                    bits={bits}
                                    defaultActiveSegments={
                                        defaultActiveSegments
                    ...
                    <aside className="min-h-0 space-y-3 xl:overflow-y-auto xl:pr-1">
                        ...
                        <RegisterTable
                            ...
                            onPcChange={
                                mode === 'assembly' ? handlePcChange : undefined
                            }
                        />
                        ...
                        <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <div className="flex items-center justify-between border-b border-slate-200 bg-[#fbfcfd] px-4 py-3 dark:border-slate-800 dark:bg-slate-900/60">
                                <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">
                                    Execution Log
                                </h2>
